    ...
    return (
        <div className='wrapper registration-wrapper'>
            <div className="vector__bg vector__bg_reg1">
                <svg width="291" height="386" viewBox="0 0 291 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#204CEC" strokeWidth="3" strokeMiterlimit="10"/>
                    <path
            ...
            <div className="vector__bg vector__bg_reg2">
                <svg width="926" height="293" viewBox="0 0 926 293" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="url(#paint0_linear_0:1)" strokeWidth="3" strokeMiterlimit="10"/>
                    <path
                        ...
                        stroke="url(#paint1_linear_0:1)" strokeWidth="3" strokeMiterlimit="10"/>
                    <defs>
                        <linearGradient id="paint0_linear_0:1" x1="463.501" y1="-147" x2="463.501" y2="291"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#204CEC"/>
                            <stop offset="1" stopColor="#FD6436"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_0:1" x1="427.001" y1="-193" x2="427.001" y2="210"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#204CEC"/>
                            <stop offset="1" stopColor="#FD6436"/>
                        </linearGradient>
            ...
            <div className="vector__bg vector__bg_reg4">
                <svg width="313" height="389" viewBox="0 0 313 389" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="vinyl-record-reg">
                <svg width="733" height="733" viewBox="0 0 733 733" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="url(#paint0_linear_753:808)" strokeWidth="250"/>
                    <defs>
                        <linearGradient id="paint0_linear_753:808" x1="366.5" y1="849.399" x2="366.5" y2="-242.236"
                                        gradientUnits="userSpaceOnUse">
                ...
                <svg className='vinyl-record__center' viewBox="0 0 400 400">
                    <path d="M200,200 m-172,0 a172,172 0 1,1 345,0 a172,172 0 1,1 -345,0" fillOpacity='0' id="tophalf"/>
                    <text fill="#fff">
            ...
            <div className="registration__notes">
                <svg width="271" height="187" viewBox="0 0 271 187" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="white" strokeWidth="2.5" strokeMiterlimit="10"/>
                    <path
            ...
            <img src="images/music-services4.svg" alt=""
                 className="music-services music-services_reg1"/> {/*ToDo Сделать движущимися*/}
