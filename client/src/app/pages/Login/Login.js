...
function Login() {
    return (
        <div className='wrapper registration-wrapper'>
            ...
            <img src="images/music-services4.svg" alt="" className="music-services music-services_reg1"/> {/*ToDo Сделать движущимися*/}
            ...
            <form action="#" className="registration-form">
                ...
                <input type="text" className="registration-form__input tl-input" placeholder='E-mail'/>
                ...
                <Captcha/>
                <p className="registration-form__text">Нет аккаунта? <a href="/registration" className="registration-form__enter-link">Зарегистрироваться</a></p>
