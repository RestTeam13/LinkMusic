                    ...
                    <div className="create__right-column">
                        <form action="#" className="create__form">
                            ...
                            <div className="create-form__block" style={{position: 'relative'}}>
                                ...
                                <input type="text" className="block-form__input-row block-form__input-row_with-help"
                                       placeholder='Имя артиста для этого релиза'/>
                            ...
                            <div className="create-form__block">
                                <div className="create-form__title create-form__title_mt30">Этот релиз на цифровых
                                    витринах
                                </div>
                            ...
                            <div className="create-form__block">
                                ...
                                <input type="text" className="block-form__input-row"
                                       placeholder='Ссылка на видео в YouTube / Vimeo'/>
                            </div>
                                ...
                                <div className="create-form__radio-row">
                                    <div className="create-form__radio-item">
                                        <label htmlFor="radio3" className="create-form__radio-label">
                                            <input type="radio" id='radio3' name='address' value='1'
                                                   className="create-form__radio"/>
                                            <span className="create-form__radio-label-checkbox"/>
                                            <p>Автоматически</p>
                                        </label>
                                    ...
                                    <div className="create-form__radio-item">
                                        <label htmlFor="radio4" className="create-form__radio-label">
                                            <input type="radio" id='radio4' name='address' value='2'
                                                   className="create-form__radio"/>
                                            <span className="create-form__radio-label-checkbox"/>
                                            <p>Вручную</p>
                                        </label>
...
export default withStandardLayout(NewRelease);