...
function ProfilePage() {//Todo Сделать лоадер
    ...
    return (
        <section className="block block-create block_first-on-page">
            ...
            <div className="content">
                ...
                {
                    userInfo.name && <div className="create_main-row">
                        <div className="load-img">
                            {
                                !!userInfo.avatar &&
                                <label htmlFor="img-load" className="load-img__label">
                                    <img src={userInfo.avatar.publicUrl} alt=""/>
                        ...
                        <div className="create__right-column">
                            <form action="#" className="create__form">
                                <div className="create-form__block">
                                    <p className="create-form__title create-form__title_mob-mt50">Основная информация</p>
                                    ...
                                    <textarea type="text"
                                              className="block-form__input-row block-form__input-row_textarea-profile"
                                ...
                                <div className="create-form__block">
                                    <div className="create-form__title create-form__title_mt30">Ссылки на соцсети</div>
                                    {
                                        userInfo.socialLinks.map(({link}) => {
                                            return <input type="text" className="block-form__input-row" key={link}
                                                          placeholder='Вставьте ссылку' defaultValue={link}/>
                                        })
                                    }
...
export default withStandardLayout(ProfilePage);
