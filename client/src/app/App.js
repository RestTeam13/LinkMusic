...
import MyReleases from "./pages/MyReleases/MyReleases";
...
function App() {
    const {token, userId, login, logout, userInfo, userInfoLoading, userInfoError} = useAuth()//Todo вынести на уровень выше? вместе с AuthContext.Provider
        ...
        return (
            <>
                <AuthContext.Provider
                    value={{token, userId, login, logout, isAuthenticated, userInfo, userInfoLoading, userInfoError}}>
                    <Routes>
