            ...
            <div className='block release-slider__slide release-slider__slide_main'>
                ...
                <div className="vector__bg vector__bg_7"> {/*ToDo дорисовать линии*/}
                    <svg width="646" height="646" viewBox="0 0 646 646" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.00097 208.167C2.00097 208.167 97.0432 243.812 158.894 158.726C228.226 63.344 339.107 103.43 370.234 175.371C401.361 247.312 322.172 319.387 417.808 419.676C515.594 522.214 441.56 638.434 441.56 638.434" stroke="#204CEC" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M55.3427 305.846C55.3427 305.846 146.404 271.354 198.737 198.755C251.07 126.156 304.039 164.517 314.943 190.029C337.542 242.949 263.791 331.21 319.518 397.473C361.414 447.261 454.398 477.553 415.925 581.321" stroke="#204CEC" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M113.813 308.357C113.813 308.357 167.808 233.969 201.381 290.496C239.869 355.245 208.233 385.297 302.702 421.515C336.304 434.328 433.036 524.979 357.043 563.212" stroke="#204CEC" strokeWidth="3" strokeMiterlimit="10"/>
                    </svg>
                </div>
