            ...
            <div className='block release-slider__slide release-slider__slide_main'>
                <div className="release-slider__main-slide-bg-img">
                    <svg width="926" height="487" viewBox="0 0 926 487" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M925 47C925 47 786.323 110.094 810.979 266.178C838.622 441.144 678.425 516.347 569.057 472.992C459.688 429.637 467.237 268.957 259.334 264.014C46.7649 258.967 2 56.8698 2 56.8698" stroke="url(#paint0_linear_1242:5)" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M764 1C764 1 704.057 134.143 725.531 266.626C747.006 399.109 650.228 414.601 611.64 399.109C531.616 366.956 516.24 195.151 386.973 183.978C289.82 175.61 159.189 242.091 90 91.2517" stroke="url(#paint1_linear_1242:5)" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M699.898 59.3233C699.898 59.3233 721.541 195.419 625.921 171.087C516.359 143.247 518.04 77.8531 379.346 139.604C330.087 161.642 131.224 168.089 171.297 47" stroke="url(#paint2_linear_1242:5)" strokeWidth="2" strokeMiterlimit="10"/>
                        <defs>
                ...
                <div className="vector__bg vector__bg_7">
                    <svg width="483" height="667" viewBox="0 0 483 667" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.1675 107.167C1.1675 107.167 96.2097 142.812 158.06 57.7256C227.392 -37.656 338.274 2.4302 369.401 74.3712C400.528 146.312 321.339 218.388 416.975 318.676C514.761 421.214 482.787 468.868 440.726 537.434C398.666 606 323.665 490.999 317.666 578C311.667 665.001 62.6674 665 62.6674 665" stroke="#204CEC" stroke-width="3" stroke-miterlimit="10"/>
                        <path d="M54.5085 204.846C54.5085 204.846 145.57 170.353 197.903 97.7547C250.236 25.1561 303.205 63.5166 314.109 89.029C336.708 141.949 262.957 230.21 318.684 296.473C360.58 346.26 452.015 403.642 415.091 480.321C378.166 557 333.609 507.262 314.109 517.5C294.61 527.738 277.665 604.499 212.666 613.5C147.666 622.5 100.666 601.5 100.666 601.5" stroke="#204CEC" stroke-width="3" stroke-miterlimit="10"/>
                        <path d="M112.981 207.357C112.981 207.357 166.975 132.969 200.549 189.496C239.037 254.245 207.401 284.297 301.87 320.515C378.166 349.766 397.165 441 356.211 462.212C315.257 483.425 284.166 465 273.666 493C263.166 521 254.664 548.5 216.665 556C178.666 563.5 122.165 506 122.165 506" stroke="#204CEC" stroke-width="3" stroke-miterlimit="10"/>
                    </svg>
                ...
                <div className="vector__bg vector__bg_8">
                    <svg width="530" height="732" viewBox="0 0 530 732" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M439.086 71.9201C439.086 71.9201 301.349 67.8329 263.339 204.329C226.16 337.828 123.703 306.71 77.8451 370.282C31.9868 433.854 54.3268 549.624 171.756 560.341C276.512 569.904 272.904 633.5 294.556 669.794C316.208 706.088 367.904 730 367.904 730" stroke="#FC6338" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M371.906 601.5C371.906 601.5 274.898 513.4 185.742 505.619C96.5859 497.838 102.416 432.697 118.747 410.268C152.633 363.761 266.209 381.92 294.595 300.124C315.909 238.645 294.32 143.263 403.154 123.18" stroke="#FC6338" strokeWidth="3" strokeMiterlimit="10"/>
                        <path d="M367.904 533C367.904 533 231.824 514.155 263.189 456.374C299.101 390.161 341.113 401.949 323.854 302.258C317.655 266.834 345.994 137.329 417.745 183.029" stroke="#FC6338" strokeWidth="3" strokeMiterlimit="10"/>
                    </svg>
                </div>
                    ...
                    <div className="release-slider__img-wrapper-color-notes">
                        <svg width="90" height="58" viewBox="0 0 90 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="url(#paint0_linear_1242:3)" strokeWidth="2.5" strokeMiterlimit="10"/>
                            <path
                                ...
                                stroke="url(#paint1_linear_1242:3)" strokeWidth="2.5" strokeMiterlimit="10"/>
                            <defs>
