                        ...
                        <form action="#" className="block-form__form">
                            ...
                            <FormControl fullWidth className='block-form__input-row block-form__input-row_select'>
                                ...
                                <Select labelId="message-form-label" id="message-form" label="Message">
                                    ...
                                    <MenuItem value={30}>Тема 3</MenuItem>
                                </Select>
                            </FormControl>
                            <div className="block-form__input-row">
                                <input type="text" className="block-form__input" placeholder='Как к вам обращаться?'/>
                            </div>
                            <div className="block-form__input-group">
                                <div className="block-form__input-row">
                                    <input type="tel" className="block-form__input" placeholder='Телефон'/>
                                </div>
                                <div className="block-form__input-row">
                                    <input type="mail" className="block-form__input" placeholder='E-mail'/>
                                </div>
                            </div>
                            ...
                            <div className="block-form__input-row block-form__input-row_file">
                                ...
                                <label htmlFor="form-file" className="block-form__label block-form__label_file">
                                    <svg width="113" height="14" viewBox="0 0 113 14" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_599:238" x1="0" y1="7.04734" x2="112.114"
                                                            y2="7.04734" gradientUnits="userSpaceOnUse">
            ...
            <div className="vector__bg vector__bg_4">
                <svg width="530" height="732" viewBox="0 0 530 732" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="url(#paint0_linear_599:61)" strokeWidth="3" strokeMiterlimit="10"/>
                    <path
                        ...
                        stroke="url(#paint1_linear_599:61)" strokeWidth="3" strokeMiterlimit="10"/>
                    <path
                        ...
                        stroke="url(#paint2_linear_599:61)" strokeWidth="3" strokeMiterlimit="10"/>
                    <defs>
                        <linearGradient id="paint0_linear_599:61" x1="345.755" y1="48.3006" x2="184.952" y2="683.7"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#3434FF"/>
                            <stop offset="1" stopColor="#FF6534"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_599:61" x1="344.268" y1="108.278" x2="228.624" y2="565.239"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#3434FF"/>
                            <stop offset="1" stopColor="#FF6534"/>
                        </linearGradient>
                        <linearGradient id="paint2_linear_599:61" x1="396.04" y1="173.895" x2="308.552" y2="519.595"
                                        gradientUnits="userSpaceOnUse">
                            <stop stopColor="#3434FF"/>
                            <stop offset="1" stopColor="#FF6534"/>
                        </linearGradient>
