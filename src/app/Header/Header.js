                ...
                <nav className="main-menu">
                    <a href='/' className="main-menu__logo">
                        <svg viewBox="0 0 411 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M31.14 58.23H35.72V81.48H55.06V86.16H31.14V58.23Z" fill="#0707FE"/>
                            <path d="M113.5 70.5L128 58L134 58L118.56 72.51C123.82 76.93 128.88 81.72 134 86H128L113.5 74L113.5 72.5L113.5 70.5Z" fill="#1212FE"/>
